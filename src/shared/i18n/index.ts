...
const messages: Record<AppLocale, MessageSchema> = {
  "zh-CN": {
    ...
    "workspace.action.history": "历史",
    "workspace.action.logs": "日志",
    "workspace.action.resetSettings": "重置设置",
    "workspace.currentTheme": "当前主题：{theme}",
    "workspace.theme.midnight": "夜航",
    "workspace.theme.sand": "砂岩",
    "workspace.theme.jade": "青岚",
    "workspace.theme.tide": "潮汐",
    "workspace.theme.graphite": "石墨",
    "connections.title": "连接",
    "connections.subtitle": "{count} 个配置",
    "connections.groupCount": "{count} 项",
    "connections.moreActions": "更多操作",
    "connections.new": "新建",
    "connections.quickConnect": "快速连接",
    "connections.clear": "清除",
    "connections.closeEditor": "关闭",
    "connections.openFiles": "打开文件",
    "connections.editInline": "编辑连接",
    "connections.treeEmpty": "暂无连接配置。",
    "connections.contextMenuLabel": "连接操作",
    ...
    "terminal.send": "发送",
    "terminal.themeLabel": "主题",
    "terminal.toggleBottomPanel": "底栏",
    "terminal.toggleLeftPane": "侧栏",
    ...
    "files.tab.files": "文件",
    "files.tab.transfers": "传输",
    "files.directories": "目录",
    "files.directoryEmpty": "当前目录下暂无子目录。",
    "files.pathPlaceholder": "输入路径后回车访问",
    "files.createdAt": "创建时间",
    "files.permissions": "权限",
    "files.ownerGroup": "所有者/分组",
    "files.actions": "操作",
    "files.unknown": "未知",
    ...
    "snippets.save": "保存片段",
    "history.title": "命令历史",
    "history.searchPlaceholder": "搜索命令、会话或主机上下文",
    "history.empty": "还没有记录到执行命令。",
    "history.run": "执行",
    "logs.title": "工作台日志",
    "logs.empty": "当前没有活动日志。",
    "toolbar.newConnection": "+ 新建",
    "toolbar.quickConnect": "快速连接",
    "toolbar.searchPlaceholder": "搜索连接",
    "toolbar.toggleSidebar": "切换侧栏",
    "toolbar.toggleTools": "切换工具区",
    "toolbar.upload": "上传",
    "toolbar.download": "下载",
    "toolbar.snippets": "片段",
    "toolbar.files": "文件",
